...
function MyApp(props){
  var {cart,addItem,removeItem, user, setUser, userName} = useContext(AppContext)
  const [state,setState] = useState({cart:cart});
  const { Component, pageProps } = props;
  const activeUser = Cookie.get('name');
  ...
  return (
    <AppContext.Provider value={{cart: state.cart, addItem: addItem, removeItem: removeItem,isAuthenticated:false,user:{activeUser},setUser:()=>{}}}>
      <Head>
        <link
          rel="stylesheet"
